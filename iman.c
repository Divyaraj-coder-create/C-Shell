...
void iman(char **entries) {
    ...
    // char pth[qt];
    // snprintf(pth,qt,"man.he.net/?topic=%s&section=all",command_name);
    ...
    if (sock_fd < 0) {
        ...
        // char get_request[MAX_REQUEST_SIZE];
        // snprintf(get_request, sizeof(get_request), "GET /%s.1.html HTTP/1.1\r\nHost: man.he.net/?topic=%s&section=all\r\n\r\n",command_name,command_name);
        char s1[qt],s2[qt],get_request[qt];
